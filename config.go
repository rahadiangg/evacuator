...
var configItems = []ConfigItem{
	...
	{"PROVIDER_POLL_INTERVAL", "provider.poll_interval", "5s"},
	{"PROVIDER_REQUEST_TIMEOUT", "provider.request_timeout", "3s"},
	...
	{"HANDLER_KUBERNETES_DELETE_EMPTY_DIR_DATA", "handler.kubernetes.delete_empty_dir_data", true},
